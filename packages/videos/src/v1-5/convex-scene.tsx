...
const LINES: Line[] = [
  ...
  [],
  [["  // Convex assigns the id — so the id is the key", "cm"]],
  [
    ["  "],
    ["const ", "kw"],
    ["id = "],
...
const DWELL = 55;
export const CONVEX_SCENE_DURATION = ENTER + TYPE_FRAMES + DWELL + EXIT;

export const ConvexScene: React.FC = () => {
  ...
  const exitOpacity = interpolate(
    frame,
    [CONVEX_SCENE_DURATION - EXIT, CONVEX_SCENE_DURATION - 2],
    [1, 0],
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Convex, from the inside.
        </div>
      </div>
      <CodeWindow
        lines={LINES}
        budget={budget}
        filename="convex/files.ts"
